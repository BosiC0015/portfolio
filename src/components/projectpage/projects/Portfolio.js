  ...
  return (
    <section id="portfolio" className="project-card">
      ...
      <div className="project-git">
        <a href="https://github.com/BosiC0015/personal-website" target="_blank" rel="noreferrer">
      ...
      <div className="project-live">
        <a href="https://bosic0015.github.io/portfolio/" target="_blank" rel="noreferrer">
